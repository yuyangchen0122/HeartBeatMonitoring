...
FROM HealthMonitoring.HeartData WHERE username="$temp" AND activity="NoActivity"
...
SELECT HeartRate,
UNIX_TIMESTAMP(CONCAT_WS(" ", Date, Time)) AS datetime
FROM HealthMonitoring.HeartData  WHERE username="$temp" AND activity="Workout"
ORDER BY Date DESC, Time DESC
';
...
SELECT HeartRate,
UNIX_TIMESTAMP(CONCAT_WS(" ", Date, Time)) AS datetime
FROM HealthMonitoring.HeartData WHERE username="$temp" AND activity="Sleeping"
ORDER BY Date DESC, Time DESC
';
...
SELECT HeartRate,
UNIX_TIMESTAMP(CONCAT_WS(" ", Date, Time)) AS datetime
FROM HealthMonitoring.HeartData  WHERE username="$temp" AND activity="Studying"
ORDER BY Date DESC, Time DESC
';
